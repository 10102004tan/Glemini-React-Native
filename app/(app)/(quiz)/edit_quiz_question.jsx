...
const EditQuizQuestion = () => {
  ...
  const { selectedQuiz, createQuestionType, setSelectedQuiz } =
    useQuizProvider();
  const {
    question,
    addAnswer,
    ...
    <Wrapper>
      ...
      <BottomSheet visible={pointBotttomSheetVisible}>
        <View className="flex flex-col items-start justify-start">
          <Text className="font-semibold text-gray">Chọn số điểm</Text>
            ...
            <ScrollView>
              {Points.questionPoints.map((point, index) => {
                return (
                  ...
                  >
                    <Text className="ml-2">{point} điểm</Text>
                  </TouchableOpacity>
                );
              })}
            </ScrollView>
      ...
      <BottomSheet visible={timeBotttomSheetVisible}>
        <View className="flex flex-col items-start justify-start">
          <Text className="font-semibold text-gray">Chọn thời gian</Text>
          <View className="flex items-center justify-start flex-row mt-4">
            <ScrollView>
              {Times.questionTimes.map((time, index) => {
                return (
                  ...
                  >
                    <Text className="ml-2">{time} giây</Text>
                  </TouchableOpacity>
                );
              })}
            </ScrollView>
