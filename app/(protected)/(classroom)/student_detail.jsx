        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (
              ...
              >
                <View
                  className={`bg-slate-200/50 mb-4 rounded-lg shadow-lg ${isExpired || isNotStartedYet ? 'opacity-50' : ''}`}
                >
                  <View className="flex-row items-center gap-4">
                    ...
                    <View>
                      ...
                      <Text className="text-base font-semibold">{item.quiz_id.quiz_name}</Text>
                      {isExpired ? (
