          ...
          <View className="flex-row w-full">
            ...
            <View className="w-2/3 h-auto flex-row items-center py-5 border-b-[1px] border-slate-300">
              ...
              <View className="w-1/5 flex items-center">
                <Text
                  className={`${completionPercentage < 30 ? 'bg-red-500/50 text-red-500' : completionPercentage < 65 ? 'bg-yellow-500/40 text-yellow-500' : 'bg-green-500/50 text-green-500'} px-1 py-2 w-12 text-center rounded-md font-bold`}
                >
          ...
          <View className="flex-row gap-4 justify-around items-center mb-4">
            ...
            >
              <Text className="text-gray-700 text-center">
                {sortOrder === 'newest' ? i18n.t('report.optionNew') : i18n.t('report.optionOld')}
              </Text>
            </TouchableOpacity>
          </View>
