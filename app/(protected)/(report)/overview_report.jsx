...
export default function DetailReport() {
    ...
    return (
        <>
            <View style={{ paddingTop: 40, paddingBottom: 8, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', backgroundColor: '#991b1b' }}
            >
            ...
            <ScrollView
                ...
                style={{ flex: 1, padding: 20 }}>
                {
                    ...
                    <View style={{ flexDirection: 'row', height: 24, borderRadius: 999, overflow: 'hidden', marginBottom: 8 }}>
                        <View style={{ flex: correctCount / overViewData.result_questions?.length, backgroundColor: '#22c55e' }} />
                        <View style={{ flex: incorrectCount / overViewData.result_questions?.length, backgroundColor: '#ef4444' }} />
                    </View>
                }
                ...
                <View
                    ...
                    <View>
                        ...
                        <Text style={{ fontWeight: 500 }}>{i18n.t('report.reportOverview.questionCorrect')}</Text>
                    </View>
                    <View>
                        ...
                        <View key={question._id} className={`mb-3 p-2 rounded-lg ${question.correct ? "bg-green-500/20 border-green-500" : "bg-red-500/20 border-red-500"} border-[1px]`}>
                            <View
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'flex-start', gap: 8 }}>
                                    ...
                                    >
                                        ...
                                        >{question.correct ? i18n.t('report.reportOverview.typeCorrect') : i18n.t('report.reportOverview.typeIncorrect')}</Text>
                                    </View>
                                </View>
                                <Text>
                            ...
                            <Text
                                style={{
                                    ...
                                    fontSize: 16,
                                    lineHeight: 24
                                }}>{question.question_id.question_excerpt}</Text>
                            <Text
                                style={{
                                    fontSize: 16, lineHeight: 24, marginTop: 8, fontWeight: 600
                                }}
                            >{`${overViewData.user_id?.user_fullname}`}</Text>
                            <Text
                                style={{
                            ...
                            <Text style={{ marginTop: 8, fontSize: 16, lineHeight: 24 }}>{i18n.t('report.reportOverview.infoAnswerCorrect')}</Text>
