      ...
      <ScrollView className="flex-1">
        ...
        <View className="flex-row p-5 bg-[#435362] mt-5 rounded-lg">
          ...
          <View className="flex ml-5 justify-around">
            <Text className="text-lg text-slate-200">{userData.user_fullname}</Text>
          ...
          <View className="flex-row h-5 mt-2 rounded-full overflow-hidden border border-white">
            <View
              style={{
                ...
                borderTopRightRadius: correctPercentage === 100 ? 10 : 0,
                borderBottomRightRadius: correctPercentage === 100 ? 10 : 0,
              }}
            />
            <View
              style={{
                ...
                borderTopLeftRadius: wrongPercentage === 100 ? 10 : 0,
                borderBottomLeftRadius: wrongPercentage === 100 ? 10 : 0,
              }}
            />
          </View>
        ...
        <View className="flex-row justify-between ">
          <View className="flex-row p-3 flex-1 mr-2 mt-5 rounded-lg bg-[#435362] justify-between items-center">
            <View className="flex-col">
              ...
              <Text className="text-xl text-slate-100 font-semibold">{score}</Text>
            </View>
            <View className="ml-5 bg-orange-400 rounded-lg p-1">
              <Icon name="ribbon-outline" size={25} color={'white'} />
            </View>
          </View>
          <View className="flex-row p-3 mt-5 w-1/2 rounded-lg bg-[#435362] justify-between items-center">
            <View className="flex-col">
              ...
              <Text className="text-xl text-slate-100 font-semibold">{totalQuestions}</Text>
            </View>
        ...
        <View className="flex-row justify-between">
          <View className="flex-row p-3 flex-1 mr-2 mt-2 rounded-lg bg-[#435362] justify-between items-center">
            <View className="flex-col">
              ...
              <Text className="text-xl text-slate-100 font-semibold">{correctCount}</Text>
            </View>
            <View className="ml-5 bg-green-500 rounded-lg p-1">
              <Icon name="checkmark-circle-outline" size={25} color={'white'} />
            </View>
          </View>
          <View className="flex-row p-3 w-1/2 mt-2 rounded-lg bg-[#435362] justify-between items-center">
            <View className="flex-col">
              <Text className="text-sm text-slate-200">{i18n.t('result.single.incorrect')}</Text>
              <Text className="text-xl text-slate-100 font-semibold">{wrongCount}</Text>
            </View>
        ...
        <View className="relative mt-4 bg-[#435362] rounded-xl border border-white">
          <Text className="p-4 bg-green-500 text-white mb-5 rounded-tl-xl rounded-tr-xl ">
            {i18n.t('room_wait_result.rankboard')}
          </Text>
          <View className="p-4" showsVerticalScrollIndicator={false}>
            {rankBoardData.rank &&
              rankBoardData.rank.length > 0 &&
