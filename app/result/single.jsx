        ...
        <View className="flex-1 bg-[#1C2833] px-5 pb-4 pt-10">
            ...
            <View className='flex p-5 bg-[#435362] mt-5 mx-3 rounded-lg'>
                ...
                <View className='flex flex-row justify-between mt-3'>
                    <Text className='text-green-500 font-semibold'>Đúng: {correctPercentage.toFixed(0)}%</Text>
                    <Text className='text-red-500 font-semibold'>Sai: {wrongPercentage.toFixed(0)}%</Text>
                </View>
            </View>
            ...
            <View className='flex-row justify-between mx-3'>
                <View className='flex-row p-3 mt-5 rounded-lg bg-[#435362] justify-between items-center'>
                    <View className='flex-col'>
                        ...
                        <Text className='text-xl text-slate-100 font-semibold'>20</Text>
                    </View>
                    <View className='ml-5 bg-orange-400 rounded-lg p-1'>
                    <Icon name='ribbon-outline' size={25} className='text-white'/>
                    </View>
                </View>
                <View className='flex-row p-3 mt-5 rounded-lg bg-[#435362] justify-between items-center'>
                    <View className='flex-col'>
