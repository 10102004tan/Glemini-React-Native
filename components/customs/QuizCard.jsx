...
const QuizCard = ({
  ...
  return (
    ...
    >
      <View>
        <Image
          source={quiz_thumb ? { uri: quiz_thumb } : Images.banner1}
          className={'w-full h-[100px] rounded-b-[10px]'}
          alt={quiz_name}
        />
        <Text
          className={
            'absolute p-2 rounded bg-white opacity-80 text-[10px] bottom-[5px] right-[5px]'
          }
        >
        ...
        <Text
          className={
            'absolute p-2 rounded bg-blue-500 text-white opacity-80 border-white text-[10px] top-[5px] left-[5px]'
          }
        >
          {question_count}
        </Text>
        <View
          className={
            'flex-row items-center gap-1 rounded bg-white absolute bottom-[5px] left-[8px] py-[2px] px-2'
          }
        >
