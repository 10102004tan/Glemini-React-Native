...
export default function SchoolItem({ handlerSelectSchool, selectedSchool, item, isScrolling }) {
  ...
  return (
    <TouchableOpacity
      onPress={() => !isScrolling && handlerSelectSchool(item)}
      className={`px-2 py-3 rounded ${!isSchoolSelected ? 'bg-[#eee]' : 'bg-amber-300'} mb-3`}
    >
      <Text className={'w-[100%] max-h-[40px] rounded-[10px] bg-white px-2 mb-2'}>
