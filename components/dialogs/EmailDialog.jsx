    ...
    >
      ...
      <View className="flex-1 justify-center items-center bg-opacity-50">
        <View className="bg-white rounded-2xl p-8 shadow-lg w-11/12 max-w-md">
          <Text className="text-lg font-semibold mb-2">{i18n.t('detailQuiz.shareQuiz')}</Text>
          <Text className="text-gray-700 mb-4">{i18n.t('detailQuiz.enterMail')}</Text>
          <TextInput
          ...
          <View className="flex-row mb-1">
            <Text className="font-bold text-[16px]">{i18n.t('detailQuiz.informationTeacher')}</Text>
            <TouchableOpacity onPress={() => setIsDetailsVisible(!isDetailsVisible)}>
          ...
          {isDetailsVisible && (
            <ScrollView className="h-[100px]">
              {clicked.map((item, index) => (
                <View key={index} className="flex-row items-center justify-between my-1">
                  ...
                  >
                    <Text className="text-white text-[12px]">{i18n.t('detailQuiz.delete')}</Text>
                  </TouchableOpacity>
                </View>
              ))}
            </ScrollView>
