        ...
        >
            <View className='flex-1 justify-center items-center bg-black/50 '>
                <View className='w-11/12 bg-white rounded-2xl overflow-hidden'>
                    <Image
                        source={quiz?.quiz_thumb ? { uri: quiz.quiz_thumb } : Images.banner1}
                    ...
                    <View className='py-2'>
                        <View className='px-4'>
                            ...
                            <Text >{quiz?.quiz_description ? truncateDescription(quiz?.quiz_description, 50) : i18n.t('student_homepage.textDesc')}</Text>
                            </View>
                        </View>
