...
const QuizModal = ({ visible = false, onClose = () => {}, onStartQuiz = () => {}, quiz }) => {
          ...
          <View className="py-2">
              ...
              <View className="flex-col mt-3 text-base">
                ...
                <Text>
                  {quiz?.quiz_description
                    ? truncateDescription(quiz?.quiz_description, 50)
            ...
            <View className="flex flex-row p-2 w-full justify-center mt-2">
              {user.user_role === 'teacher' ? (
                user.user_id === quiz?.user_id ? (
                  <TouchableOpacity
                    onPress={handlerEditQuiz}
                    className={'flex-row p-2 rounded gap-2 items-center bg-green-400'}
                  >
                  ...
                  <View className={'flex-row gap-2'}>
                    ...
                    <TouchableOpacity
                      onPress={handlerDetailQuiz}
                      className={'flex-row p-2 rounded gap-2 items-center bg-amber-600'}
                    >
                ...
                <View className="flex-row items-center">
                  <Button
                    text={i18n.t('student_homepage.btnLuyenTap')}
                    loading={false}
                    type="fill"
